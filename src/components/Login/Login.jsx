    ...
    <div className="w-full max-w-xs m-auto">
      ...
      <form onSubmit={handleSubmit} className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
        ...
        <div className="flex items-center justify-between">
          ...
          <Link to='/resetPassword' className="inline-block align-baseline font-bold text-sm text-blue-500 hover:text-blue-800">Forgot Password?</Link>
        </div>
      ...
      <button className="bg-slate-50 hover:bg-slate-200 text-black shadow-md rounded border-2 border-gray-300 py-2 px-4 w-full" onClick={handleGoogleSingin}>
        Login with Google
      </button>
    </div>
  )
